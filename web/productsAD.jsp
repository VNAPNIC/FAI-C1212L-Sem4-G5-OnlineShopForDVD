<%-- 
    Document   : productsAD
    Created on : Sep 7, 2015, 9:55:37 AM
    Author     : hainam1421
--%>
                                        ...
                                        <tbody>
                                            <s:iterator value="objs">
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><img height="300px" width="240px" src="<s:property value="img"/>" alt="" /></td>
                                                    

                                                    <td class="center"> 
                                                        <s:url action="#" var="viewdt">
                                                            <s:param name="p_id">${p_id}</s:param>
                                                        </s:url>
                                                        <s:a href="%{viewdt}">Edit</s:a>
                                                        </td>

                                                        <td class="center">
                                                        <s:url action="#" var="remove">
                                                            <s:param name="p_id">${p_id}</s:param>
                                                        </s:url>
                                                        ...
                                                        <s:if test="active">
                                                            <s:url action="#" var="cf">
                                                                <s:param name="stt">False</s:param>
                                                                <s:param name="p_id">${p_id}</s:param>
                                                            </s:url>
                                                            <s:a href="%{at}">True</s:a>
                                                        </s:if>
                                                        <s:else>
                                                            <s:url action="#" var="cf">
                                                                <s:param name="stt">True</s:param>
                                                                <s:param name="p_id">${p_id}</s:param>
                                                            </s:url>
                                                            <s:a href="%{at}">False</s:a>
                                                        </s:else>
                                                    </td>
